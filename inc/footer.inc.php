		...
		<div class="modal-body">
				...
				<div class="controls">
					<div class="input-prepend">
						<span class="add-on"><i class=" icon-user"></i></span> <input
							type="text" id="register_username" placeholder="用户名"
							class="span3">
					</div>
				</div>
			</div>
				...
				<div class="controls">
					<div class="input-prepend">
						<span class="add-on"><i class="icon-lock"></i></span> <input
							type="password" id="register_password1" placeholder="密码"
							class="span3">
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-prepend">
						<span class="add-on"><i class="icon-lock"></i></span> <input
							type="password" id="register_password2" placeholder="确认密码"
							class="span3">
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-prepend">
						<span class="add-on"><i class=" icon-user"></i></span> <input
							type="text" id="register_realname" placeholder="真实姓名"
							class="span3">
					</div>
				</div>
			</div>
				...
				<div class="controls">
					<div class="input-prepend">
						<span class="add-on"><i class="icon-envelope"></i></span> <input
							class="span2" id="register_email" type="text" placeholder="邮箱">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="modal-body">
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-prepend">
						<span class="add-on"><i class=" icon-user"></i></span> <input
							type="text" id="login_username" placeholder="用户名" class="span3">
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-prepend">
						<span class="add-on"><i class="icon-lock"></i></span> <input
							type="password" id="login_password" placeholder="密码"
							class="span3">
					</div>
